...
void main() {
  runApp(const ProviderStudy());
}

class ProviderStudy extends StatelessWidget {
  const ProviderStudy({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      child: Home(),),  //child 하위에 있는 모든 위젯들은 Provider에 접근가능하게 됨
    );
  }
